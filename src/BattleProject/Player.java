...
public class Player implements BattlePlayers {
  ...
  public Player(String playerName, RandomNumbersGenerator randomVariable) {
    ...
    this.health = getPlayerConstitution() + getPlayerStrength() + getPlayerDexterity() + getPlayerCharisma();
  ...
  public String toStringGear() {
    ...
    for (Gear g : getPlayerGear()) {
      sb.append("Gear Name is : ").append(g.getGearName()).append(" Gear power is : ").append(g.getPower()).append("\n");
    }
    return sb.toString();
  }
